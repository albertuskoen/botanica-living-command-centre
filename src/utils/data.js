...
export const INIT_CLIENTS = [
  ...
  { id:403, company:'Tsogo Sun Hotels', sector:'Hospitality', type:'Strategic Account', priority:'High', status:'Not Contacted', website:'tsogosun.com', email:'', phone:'', hqAddress:'Johannesburg', contactPerson:'', position:'', department:'Procurement / Facilities', notes:'One of the largest hotel groups in Africa. Operates InterContinental, Radisson Blu and own-brand hotels. High-volume greenery opportunity across lobby, conference and F&B spaces.', followUpDate:'' },
  { id:404, company:'City Lodge Hotels', sector:'Hospitality', type:'Strategic Account', priority:'Medium', status:'Not Contacted', website:'citylodge.co.za', email:'', phone:'', hqAddress:'Johannesburg', contactPerson:'', position:'', department:'', notes:'Listed hotel group with 60+ properties across SA and rest of Africa. Budget to mid-market positioning. Volume-based opportunity for reception and corridor areas.', followUpDate:'' },
