            ...
            <>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
                {[
                  ...
                  { step:'3', icon:'📦', title:'Create storage bucket', detail:<>In Supabase Dashboard → <strong>Storage → New bucket</strong>. Name: <code>Botanica living - Documents</code>. Toggle <strong>Public</strong> ON for simplest setup.</> },
